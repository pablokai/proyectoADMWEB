...
{
    public partial class Admin_ConfigB : System.Web.UI.Page
    {
        ...
        protected void btnmodmsj1_Click(object sender, EventArgs e)
        {
            Session["MSJAceptacion"] = txtmsjAcepta.Value;
        }

        protected void btnmodmsj2_Click(object sender, EventArgs e)
        {
            Session["MSJRechazo"] = txtmsjRecha.Value;
        }
    }
}