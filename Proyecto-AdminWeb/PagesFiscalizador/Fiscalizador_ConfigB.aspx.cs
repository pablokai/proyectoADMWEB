...
{
    public partial class Fiscalizador_ConfigB : System.Web.UI.Page
    {
        ...
        protected void btnmodmsobs1_Click(object sender, EventArgs e)
        {
            Session["MSJobservacion"] = txtobservacion.Value;
        }
    }
}