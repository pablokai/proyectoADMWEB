<%@ Page Title="" Language="C#" MasterPageFile="~/Director.Master" AutoEventWireup="true" CodeBehind="config.aspx.cs" Inherits="Proyecto_AdminWeb.PagesDirector.config" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="unocompleto">
            <div class="center">
				...
				<asp:Button ID="btnconfigdirector" runat="server" CssClass="btn" Text="Actualizar" OnClick="btnconfigdirector_Click"    />
